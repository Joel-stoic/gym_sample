    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-white/[0.08] bg-white/[0.04] pl-9 pr-10 py-2.5 text-[13px] text-white placeholder:text-[#3d3d52] focus:border-crayola/50 focus:outline-none transition-colors"
        />
        <button
          type="button"
