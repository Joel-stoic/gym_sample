...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!hydrated) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-black via-black to-[#3a0a0d]">
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gradient-to-b from-black via-black to-[#4a0a0f]">
