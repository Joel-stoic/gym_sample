...
export default function Header() {
  ...
  return (
    <header
      className={`flex-shrink-0 flex items-center justify-between px-4 py-5 md:px-6 bg-background/80 backdrop-blur-xl border-b border-black/10 dark:border-white/10 ${inter.className}`}
    >
