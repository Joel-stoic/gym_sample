...
export default function Header() {
  ...
  return (
    <header
      ...
      className={`h-[72px] flex-shrink-0 flex items-center justify-between px-4 md:px-6 bg-background/30 backdrop-blur-2xl backdrop-saturate-150 border-b border-black/10 dark:border-white/10 ${inter.className}`}
    >
